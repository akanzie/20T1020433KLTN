...
namespace KLTN20T1020433.DataLayers.SQLServer
{
    public class TestDAL : _BaseDAL, ITestDAL
    {
        ...
        public async Task<bool> AddStudentParticipantTest(string studentId, int testId)
        {
            ...
            {
                // Xử lý ngoại lệ ở đây, ví dụ: ghi log, thông báo lỗi, hoặc xử lý khác
                Console.WriteLine("Đã xảy ra lỗi khi thêm sinh viên tham gia bài kiểm tra: " + ex.Message);
                throw new DataException(); // Ném lại ngoại lệ để cho phép mã gọi phương thức xử lý ngoại lệ.
            }
        }
        ...
        public async Task<bool> DeleteStudentParticipantTest(string studentId, int testId)
        {
            ...
            {
                Console.WriteLine("Đã xảy ra lỗi khi xóa sinh viên tham gia bài kiểm tra: " + ex.Message);
                throw;
            }
        }
        ...
        public async Task<IList<Student>> GetStudentIdsParticipantTest(int testId)
        {
            ...
            {
                Console.WriteLine("Đã xảy ra lỗi khi truy vấn danh sách sinh viên tham gia bài kiểm tra: " + ex.Message);
                throw;
            }
        }
