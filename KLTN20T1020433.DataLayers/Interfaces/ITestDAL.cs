...
namespace KLTN20T1020433.DomainModels.Interfaces
{
    public interface ITestDAL
    {
        ...
        /// <returns></returns>
        Task<bool> AddStudentParticipantTest(string studentId, int testId);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="studentId"></param>
        /// <param name="examId"></param>
        /// <returns></returns>
        Task<bool> DeleteStudentParticipantTest(string studentId, int testId);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="testId"></param>
        /// <returns></returns>
        Task<IList<Student>> GetStudentIdsParticipantTest(int testId);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="testId"></param>
